...
import os
import pandas as pd
code_dir = 'FlowchartEasy/MermaidCode/'
image_dir = 'FlowchartEasy/MermaidImage/'
...
while True:
    ...
    i+=1
    # break
df.to_json("./FlowchartDiagramDatasetEasy.json", orient="records", indent=4)
