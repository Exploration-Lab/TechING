...
def generate_sequence_components(min_actors=5, max_actors=7, min_participants=5, max_participants=6):
...
def generate_interactions(actors, participants, min_interactions=5, max_interactions=6):
